...
export class ChatController {
    ...
    async addUserMessage(@Param('sessionId') sessionId: number, @Body('content') content: string) {
    ...
    @Post(':sessionId/action/:actionId/confirmactions')
    async confirmAction(@Param('sessionId') sessionId: number, @Param('actionId') actionId: number) {
